    ...
    class LogAnalyzerTestsWithHandWrittenFakes
    {
        ...
        public void Analyze_LoggerThrows_CallsWebService()
        {
           FakeWebService mockWebService = new FakeWebService();
            ...
            FakeLogger2 stubLogger = new FakeLogger2 {WillThrow = new Exception("fake exception")};

            LogAnalyzer2 analyzer2 = new LogAnalyzer2(stubLogger, mockWebService) {MinNameLength = 8};
        ...
        public void Analyze_LoggerThrows_CallsWebServiceWithNSub()
        {
            ...
            var analyzer =
                new LogAnalyzer2(stubLogger, mockWebService) {MinNameLength = 10};
        ...
        public void Analyze_LoggerThrows_CallsWebServiceWithNSubObject()
        {
            ...
            var analyzer =
                new LogAnalyzer3(stubLogger, mockWebService) {MinNameLength = 10};
